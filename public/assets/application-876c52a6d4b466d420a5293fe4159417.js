...
(function() { this.JST || (this.JST = {}); this.JST["templates/calendar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<iframe src="https://www.google.com/calendar/embed?src=iris.uiuc%40gmail.com&ctz=America/Chicago" style="border: 0; width: 100%; height: 100%; background-color: #51668C; padding: 10px;" frameborder="0" scrolling="no"></iframe>\n');}return __p.join('');};
}).call(this);

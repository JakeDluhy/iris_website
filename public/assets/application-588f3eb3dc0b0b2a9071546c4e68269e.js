...
(function() { this.JST || (this.JST = {}); this.JST["templates/calendar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<iframe src="https://www.google.com/calendar/embed?src=iris.uiuc%40gmail.com&ctz=America/Chicago" style="border: 0; width: 100%; height: 100%;" frameborder="0" scrolling="no"></iframe>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/filtering"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- <div class="filter-link-header">\n  <div class="info">\n    FILTER\n  </div>\n  <div class="info active-info">\n  </div>\n</div>\n<div class="filters-container">\n  <div class="filter-link" data-filter="all">\n    <div class="info">\n      ALL\n    </div>\n  </div>\n  <div class="filter-link" data-filter="general">\n    <div class="info">\n      GEN\n    </div>\n  </div>\n  <div class="filter-link" data-filter="team">\n    <div class="info">\n      TEAM\n    </div>\n  </div>\n  <div class="filter-link" data-filter="subteam">\n    <div class="info">\n      SUB\n    </div>\n  </div>\n</div> -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/nav"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<i class="fa fa-',  symbol ,'"></i>\n<img src="http://res.cloudinary.com/illinois-robotics-in-space/image/upload/v1410737620/arrow-left_iwbkvw.png" class="orange left-arrow hidden">\n<img src="http://res.cloudinary.com/illinois-robotics-in-space/image/upload/v1410756054/arrow-left-black_mpxvbj.png" class="nav-arrow left-arrow hidden">\n<img src="http://res.cloudinary.com/illinois-robotics-in-space/image/upload/v1410737620/arrow-right_wec7kd.png" class="orange right-arrow hidden">\n<img src="http://res.cloudinary.com/illinois-robotics-in-space/image/upload/v1410756054/arrow-right-black_pzvuof.png" class="nav-arrow right-arrow hidden">\n');}return __p.join('');};
}).call(this);

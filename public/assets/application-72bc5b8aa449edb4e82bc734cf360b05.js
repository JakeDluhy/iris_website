...
(function() { this.JST || (this.JST = {}); this.JST["templates/show_instruction"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="full-width-card show-instruction">\n  <h4>',  title ,'</h4><h4 class="order-id">',  order_id ,'</h4>\n  <p>',  content ,'</p>\n</div>\n');}return __p.join('');};
}).call(this);
